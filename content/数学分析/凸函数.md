...
**Df 1.2（中点凸）：**$E \subseteq \mathbb{R}^n$ 为凸集，$f: E \to \mathbb{R}$ 称 $f$ 为“中点凸”当且仅当对任意 $x, y \in E$ 有
$$
f\left(\frac{x+y}{2}\right) \le \frac{1}{2}f(x) + \frac{1}{2}f(y)
$$
...
推论 (Hölder 不等式)
$$
\sum_{n=1}^{\infty} |a_n b_n| \le \left( \sum_{n=1}^{\infty} |a_n|^p \right)^{\frac{1}{p}} \left( \sum_{n=1}^{\infty} |b_n|^q \right)^{\frac{1}{q}}
$$
